	...
	<div class="row">
		<div class="col-lg-8 create-submenu">
			...
			<table class="table table-striped">
			    ...
			    <tr>
                    <td>Inlämningsuppgift 1 - Funktioner</td>
			    </tr>
				<tr>
                    <td>Inlämningsuppgift 2 - If-satser och loopar</td>
			    </tr>
				<tr>
                    <td>Inlämningsuppgift 3 - Listor och lexikon</td>
			    </tr>
				<tr>
                    <td>Inlämningsuppgift 4 - Fil- och felhantering</td>
			    </tr>
				<tr>
                    <td>Inlämningsuppgift 5 - Webben</td>
			    </tr>
			</table>
		</div>
